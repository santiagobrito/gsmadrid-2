        ...
        <Container>
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-16">
            ...
            <div>
              ...
              <div className="mt-8 inline-flex items-center gap-3 rounded-2xl bg-[#2563EB]/10 px-6 py-3">
            ...
            <div className="relative">
              ...
              <div className="pointer-events-none absolute -bottom-6 -right-6 -z-10 h-[200px] w-[200px] rounded-full bg-[#2563EB]/[0.06]" />
            </div>
          </div>
        </Container>
      </section>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            {benefits.map((item) => {
              ...
              return (
                <Card key={item.title}>
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#2563EB]/10 to-[#2563EB]/10">
